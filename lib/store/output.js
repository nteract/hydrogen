...
import { MediaTypes } from "./../components/result-view/transforms";
  ...
  get isPlain(): boolean {
    ...
    switch (output.output_type) {
      ...
      case "display_data": {
        ...
        let mimetype = "";
        _.forEach(MediaTypes, function(MediaType, index) {
          if (output.data[MediaType.defaultProps.mediaType]) {
            mimetype = MediaType.defaultProps.mediaType;
            return false;
          }
        });
