...
export class Store {
  ...
  addAutocomplete: Function | null = null;
  ...
  enableAutocomplete(watchEditor: Function) {
    this.addAutocomplete = watchEditor;
    for (let kernel of this.runningKernels) {
      kernel.watchesStore.addAutocomplete();
    }
    return new Disposable(() => this.disableAutocomplete());
  }

  disableAutocomplete() {
    this.addAutocomplete = null;
    for (let kernel of this.runningKernels) {
