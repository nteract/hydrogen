...
import AutocompleteProvider from "../services/consumed/autocomplete";
...
export default class WatchesStore {
  ...
  constructor(kernel: Kernel) {
    ...
    AutocompleteProvider.register(this.autocompleteDisposables);
    this.addWatch();
  }
  ...
  createWatch = () => {
    ...
    if (!lastWatch || lastWatch.getCode().trim() !== "") {
      ...
      AutocompleteProvider.addAutocompleteToWatch(this, watch);
      return watch;
    }
    return lastWatch;
  };
  ...
  removeWatch = () => {
    ...
    const watchesPicker = new SelectListView({
      ...
      didConfirmSelection: watch => {
        ...
        AutocompleteProvider.removeAutocompleteFromWatch(this, selectedWatch);
  ...
  destroy() {
    AutocompleteProvider.dispose(this.autocompleteDisposables);
  }
}
