...
import {
  registerAutocompleteDisposable,
  disposeAutocompleteDisposable,
  addAutocompleteToWatch,
  removeAutocompleteFromWatch
} from "../services/consumed/autocomplete";
...
export default class WatchesStore {
  ...
  constructor(kernel: Kernel) {
    ...
    registerAutocompleteDisposable(this.autocompleteDisposables);
    this.addWatch();
  }
  ...
  createWatch = () => {
    ...
    if (!lastWatch || lastWatch.getCode().trim() !== "") {
      ...
      addAutocompleteToWatch(this, watch);
      return watch;
    }
    return lastWatch;
  };
  ...
  removeWatch = () => {
    ...
    const watchesPicker = new SelectListView({
      ...
      didConfirmSelection: watch => {
        ...
        removeAutocompleteFromWatch(this, selectedWatch);
  ...
  destroy() {
    disposeAutocompleteDisposable(this.autocompleteDisposables);
  }
}
