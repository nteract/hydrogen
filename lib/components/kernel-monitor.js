...
import { isUnsavedFilePath, isDeletedFilePath } from "../utils";
...
const openUnsavedEditor = (filePath: string) => {
  ...
  // unsaved editor is caught by `isDeletedFilePath`, but is kept here just for safety.
  if (!editor) return;
