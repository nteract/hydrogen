...
const Config = {
  ...
  schema: {
    ...
    autocompleteSuggestionPriority: {
      ...
      description:
        "Specify the sort order of Hydrogen's autocomplete suggestions. Note the default providers like snippets have priority of `1`. Requires Atom restart to take an effect.",
      type: "integer",
      default: 3,
      order: 1
    },
