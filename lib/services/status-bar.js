...
export function addStatusBar(store: Store, statusBar: atom$StatusBar, handleKernelCommand: Funtion) {
...
class SignalListView {
  ...
  async toggle() {
    ...
    const commands =
      this.kernel.transport instanceof WSKernel
