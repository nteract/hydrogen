...
const Hydrogen = {
  ...
  onEditorChanged(editor) {
    if (this.editor !== editor) {
      ...
      this.onKernelChanged(store.currentKernel.kernelClass);
    }
  },
  ...
  handleKernelCommand({ command, payload }) {
    ...
    if (command === 'interrupt-kernel') {
      ...
      kernel.kernelClass.shutdown();
      store.disposeCurrentKernel();
    ...
    } else if (command === 'rename-kernel' && kernel.kernelClass.promptRename) {
      kernel.kernelClass.promptRename();
