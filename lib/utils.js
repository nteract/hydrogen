...
export function deletedFilePath(filePath: string): string {
  return filePath + " (Destroyed)";
}
...
export const isDeletedFilePath = (filePath: string): boolean => {
  return filePath.match(/^.*\s\(Destroyed\)$/) ? true : false;
};
